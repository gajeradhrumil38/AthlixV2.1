...
const EXACT_TYPE_MAP: Record<string, ExerciseInputType> = {
  ...
  'vinyasa flow':           'time_only',
  'vinyasa':                'time_only',
  'yin yoga':               'time_only',
  'power yoga':             'time_only',
  'warrior i':              'time_only',
  'warrior ii':             'time_only',
  'warrior iii':            'time_only',
  'warrior 1':              'time_only',
  'warrior 2':              'time_only',
  'warrior 3':              'time_only',
  'triangle pose':          'time_only',
  'tree pose':              'time_only',
  'chair pose':             'time_only',
  'mountain pose':          'time_only',
  'eagle pose':             'time_only',
  'downward dog':           'time_only',
  'upward dog':             'time_only',
  'cobra pose':             'time_only',
  'camel pose':             'time_only',
  'wheel pose':             'time_only',
  'bridge pose':            'time_only',
  'bow pose':               'time_only',
  'pigeon pose':            'time_only',
  'seated forward fold':    'time_only',
  'butterfly stretch':      'time_only',
  'supine twist':           'time_only',
  "child's pose":           'time_only',
  'childs pose':            'time_only',
  'happy baby':             'time_only',
  'legs up the wall':       'time_only',
  'corpse pose':            'time_only',
  'savasana':               'time_only',
  'cat cow':                'time_only',
  'cat-cow':                'time_only',
