...
const DEFAULT_EXERCISES: Record<string, string[]> = {
  Chest: ['Bench Press', 'Incline Bench Press', 'Cable Fly', 'Push-Ups', 'Chest Dips'],
  Back: ['Deadlift', 'Pull-Ups', 'Lat Pulldown', 'Seated Cable Row', 'Bent Over Row'],
  Shoulders: ['Overhead Press', 'Dumbbell Shoulder Press', 'Lateral Raise', 'Arnold Press'],
  ...
  Legs: ['Squat', 'Leg Press', 'Romanian Deadlift', 'Bulgarian Split Squat', 'Calf Raises'],
  Core: ['Plank', 'Crunches', 'Hanging Knee Raise', 'Ab Wheel Rollout'],
  Cardio: ['Treadmill', 'Cycling', 'Rowing Machine', 'Elliptical'],
};
